...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/3b773c96ce.js" crossorigin="anonymous"></script>
    <title>HRR43 FEC TeamHan!</title>
  </head>
  <body>
    <div>
      <div id="booking" style="display: inline-block, z-index:1000"></div>
      <div id="carousel" style="display: inline-block></div>
    </div>
    <div id="about"></div>
    <div id="reviews"></div>
